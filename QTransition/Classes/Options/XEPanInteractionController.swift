//
//  XEPanInteractionController.swift
//  XELibraryPodsEditor
//
//  Created by Will Qiu on 2017-04-19.
//  Copyright © 2017 XE.com. All rights reserved.
//

import UIKit

public class XEPanInteractionController: UIPercentDrivenInteractiveTransition
{
    ...
    */
    ...
    {
        let gesture = UIScreenEdgePanGestureRecognizer(target: self, action: #selector(XEPanInteractionController.handleDismissGesture(gestureRecognizer:)))
    ...
    {
        let gesture = UIPanGestureRecognizer(target: self, action: #selector(XEPanInteractionController.handleDismissGesture(gestureRecognizer:)))
        view.addGestureRecognizer(gesture)
    }
    ...
    {
        let gesture = UIScreenEdgePanGestureRecognizer(target: self, action: #selector(XEPanInteractionController.handlePresentGesture(gestureRecognizer:)))
        gesture.edges = self.gestureEdges
...
extension XEPanInteractionController: UIGestureRecognizerDelegate
{
